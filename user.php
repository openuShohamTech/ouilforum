...
if ($isspecificcourse) {
    ...
    if ($hasparentaccess) {
        // A `parent` role won't likely have access to the course so we won't attempt to enter it.
        // We will however still make them jump through the normal login hoops.
        require_login();
