...
/**
 * The mod_ouilforum subscription deleted event.
 *
...
/**
 * The mod_ouilforum subscription deleted event class.
 *
...
class subscription_deleted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'ouilforum_subscriptions';
    }
    ...
    public static function get_name() {
        return get_string('eventsubscriptiondeleted', 'mod_ouilforum');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ouilforum', 'unsubscribe', 'view.php?f=' . $this->other['forumid'],
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'ouilforum_subscriptions', 'restore' => 'ouilforum_subscription');
    }
