 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class discussion_marked_read extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has marked the discussion with id '$this->objectid' in the forum " .
            "with the course module id '$this->contextinstanceid' as read.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ouilforum', 'discussion marked as read', 'discuss.php?d=' . $this->objectid,
