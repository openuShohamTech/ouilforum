...
/**
 * The mod_ouilforum post deleted event.
 *
...
/**
 * The mod_ouilforum post deleted event class.
 *
...
class post_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostdeleted', 'mod_ouilforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'ouilforum', 'delete post', $logurl, $this->objectid, $this->contextinstanceid);
    }
