...
/**
 * The mod_ouilforum post moved event class.
 *
...
class post_moved extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/ouilforum/discuss.php', array('d' => $this->other['todiscussionid']), 'p'.$this->objectid);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ouilforum', 'move post', 'discuss.php?d='.$this->other['todiscussionid'].'#p'.$this->objectid,
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['fromdiscussionid'] = array('db' => 'ouilforum_discussions', 'restore' => 'ouilforum_discussions');
        $othermapped['todiscussionid'] = array('db' => 'ouilforum_discussions', 'restore' => 'ouilforum_discussions');
