...
$search    = trim(optional_param('search', '', PARAM_NOTAGS)); // Dearch string.
$page      = optional_param('page', 0, PARAM_INT);             // Ehich page to show.
...
$fromday    = optional_param('fromday', 0, PARAM_INT);    // Starting date (day).
$frommonth  = optional_param('frommonth', 0, PARAM_INT);  // Starting date (month}.
$fromyear   = optional_param('fromyear', 0, PARAM_INT);   // Starting date (year}.
$fromhour   = optional_param('fromhour', 0, PARAM_INT);   // Starting date (hour).
$fromminute = optional_param('fromminute', 0, PARAM_INT); // Starting date (minute).
...
$today    = optional_param('today', 0, PARAM_INT);    // Ending date (day).
$tomonth  = optional_param('tomonth', 0, PARAM_INT);  // Ending date (month).
$toyear   = optional_param('toyear', 0, PARAM_INT);   // Ending date (year).
$tohour   = optional_param('tohour', 0, PARAM_INT);   // Ending date (hour).
$tominute = optional_param('tominute', 0, PARAM_INT); // Ending date (minute).
