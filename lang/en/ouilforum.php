...
$string['actionsuccess'] = 'Action completed';
$string['actionfail'] = 'Action failed';
$string['activityoverview'] = 'There are new forum posts';
$string['activityoverview_news'] = 'News';
$string['addanewdiscussion'] = 'Add a new discussion topic';
$string['addanewquestion'] = 'Add a new question';
$string['addanewtopic'] = 'Add a new topic';
$string['adddiscussion'] = 'Add discussion';
$string['addnewdiscussiontitle'] = 'Add a new discussion';
$string['addnewpost'] = 'Add a new post';
...
$string['cannotdeletesinglediscussion'] = 'You cannot delete a discussion in a single discussion forum.';
...
$string['cannotmove'] = 'You are not allowed to move a discussion';
$string['cannotmoveandsplit'] = 'You are not allowed to move or split a discussion';
...
$string['cannotreplylockeddiscussion'] = 'The discussion was locked my the forum admin. You cannot reply to a locked discussion';
...
$string['clicktounsubscribe'] = 'Unsubscribe discussion.';
$string['clicktounsubscribe:info'] = 'You are subscribed to this discussion. Click to unsubscribe.';
$string['clicktosubscribe'] = 'Subscribed to this discussion';
$string['clicktosubscribe:info'] = 'You are not subscribed to this discussion. Click to subscribe.';
$string['closediscussionthread'] = 'Collapse discussion';
...
$string['configreplieslimit'] = 'Maximum replies to display per discussion in a view page.
If the limit is reached, a notice message will appear with a link to a discussion page where all replies will be displayed.';
...
$string['configshortnamedelimiter'] = 'A single character to use in extracting from a course short name (for example: "-" in "12345 - some text").<br>
Make sure to use a valid character like "-" or ":". White spaces are ignored.<br>
This will be used only if the split option is used.';
$string['configshortpost'] = 'Any post under this length (in characters not including HTML) is considered short (see below).';
$string['configsplitshortname'] = 'Extract part of the course short name for informatic use.<br>
Some institutes add a unique string to the short name (like an identification number).<br>
The extracted value will be used in places like forwarding posts via email.
Here you can choose from where to extract the value.
You will also need to specify a delimiter in order for this option to be used.';
...
$string['confirmdiscardcontent'] = 'The content will be discarded. Continue?';
$string['confirmdiscardcontentlock'] = 'Locking the discussion will cancel any unsent reply. continue with the locking action?';
...
$string['copylink:close'] = 'Close';
$string['copylink:copied'] = 'Copied to clipboard';
$string['copylink:copy'] = 'Copy';
$string['copylink:failed'] = 'Copy failed';
$string['copylink:gotolink'] = 'Go to discussion';
$string['copylink:notsupported'] = 'This action is not suppoerted by your browser, please copy manually';
$string['copylink:title'] = 'Copy post link';
...
$string['deleteprevented'] = 'You cannot delete this post!';
$string['deletesure'] = 'Are you sure you want to delete this post?';
$string['deletesureplural'] = 'Are you sure you want to delete this post and all replies? <span class="nowrap">({$a} posts)</span>';
$string['destinationnotsameforum'] = 'The destination is not in this forum';
$string['destinationpostdiscussionnotexist'] = 'Destination post\'s discussion does not exist';
$string['destinationpostnotexist'] = 'Destination post does not exist';
...
$string['digestmailheaderfull'] = 'This is your daily digest of new posts from forums with full digest subscriptions';
$string['digestmailheadersubject'] = 'This is your daily digest of new posts from forums with subject digest subscriptions';
...
$string['discussionflag'] = 'This discussion has flagged posts';
$string['discussionislocked'] = 'Discussion is locked';
...
$string['discussionnoreplies'] = 'The discussion has no replies';
...
$string['discussionpinned'] = 'Discussion is pinned';
$string['discussionrecommend'] = 'This discussion has recommended posts';
$string['discussionreplies'] = 'The discussion has {$a} replies';
$string['discussionreply'] = 'The discussion has one reply';
...
$string['discussionunread'] = 'This discussion has unread posts';
...
$string['donotreplyemail'] = 'This is an automatic email, do not reply this message.';
$string['duration_new_message'] = 'The duration of time in days in which a post in a news forum is considered new';
$string['duration_new_message_desc'] = 'The duration of time in days in which a post in a news forum is considered new';
...
$string['editsubjectcancel'] = 'Cancel edit subject';
$string['editsubjectstart'] = 'Edit subject';
$string['emaildigeststatusshort'] = 'Digest subscription';
...
$string['emptyposttitle'] = '(nc)';
$string['enabled'] = 'Enabled';
$string['enableredirectpage'] = 'Enable redirect page';
$string['errorcopypostnoparent'] = 'Cannot copy post, parent not found';
$string['errorcopyparentpost'] = 'Error copying the post\'s parent';
$string['errorcreatenewdiscussion'] = 'Error creating a new discussion';
$string['errordeleterss'] = 'Could not delete RSS cache for selected forums';
$string['erroremptymessage'] = 'Post message cannot be empty';
$string['erroremptysubject'] = 'Post subject cannot be empty.';
$string['errorenrolmentrequired'] = 'You must be enrolled in this course to access this content';
$string['errorforwardemail'] = 'Error sending email to {$a}. Mail wasn\'t sent';
$string['errorpostmove'] = 'You need to select a target post';
$string['errorsubscribediscussion:unsubscribable'] = 'You cannot subscribe to the discussion since the subscription option to the forum was removed';
$string['errorsubscribediscussion:subscribedtoforum'] = 'You cannot subscribe to the discussion since you are subscribed to the whole forum';
...
$string['eventdiscussionmarkedread'] = 'Discussion marked as read';
...
$string['eventforummarkedread'] = 'Forum marked as read';
$string['eventforumssearched'] = 'Search in forums';
$string['eventforumtrackcreated'] = 'Forum track created';
$string['eventforumtrackdeleted'] = 'Forum track deleted';
$string['eventforumviewed'] = 'Forum viewed';
$string['eventmailblocked'] = 'User\'s email is blocked';
$string['eventmaildigesterror'] = 'Error sending digest email to user';
$string['eventmailerror'] = 'Error sending email to user';
$string['eventmailsent'] = 'Email sent to user';
$string['eventuserreportviewed'] = 'User report viewed';
$string['eventpostcopied'] = 'Post copied';
$string['eventpostcreated'] = 'Post created';
$string['eventpostdeleted'] = 'Post deleted';
$string['eventpostmoved'] = 'Post moved';
$string['eventpostmovedsameforum'] = 'Post move into same forum';
...
$string['eventsubscriptionsdeleted'] = 'Subscriptions deleted';
$string['eventdiscussionmoved'] = 'Post moved';
...
$string['filterpostconfig'] = 'Filter post content';
$string['filterpostconfig_desc'] = 'Filter content while posting. Each line is a new regex string.';
$string['firstpostattachments'] = 'The first post contains attachments';
$string['firstpostempty'] = 'The first post has no content';
$string['flag:level'] = 'Flag post level';
$string['flag:level0'] = 'Unflag post';
$string['flag:menulevel'] = 'Post has flag level';
$string['flag:menulevel0'] = 'Post is not flagged';
$string['flagoff'] = 'Flag off';
$string['flagon'] = 'Flag on';
...
$string['forumsubscription_help'] = 'Forum subscription enables the user to receive copies of posts via email (around 15 minutes from posting).
You can subscribe to some or all forums.';
$string['forumname'] = 'Forum name';
$string['forumposts'] = 'Forum posts';
$string['forums'] = 'Forums';
$string['foruminfohide'] = 'Hide forum info';
$string['foruminfohideall'] = 'Hide info of forums in the list';
$string['foruminfoshow'] = 'Show forum info';
$string['foruminfoshowall'] = 'Show info of forums in the list';
$string['forumsubjecthidden'] = 'Subject (hidden)';
$string['forumtracked'] = 'Unread posts are being tracked';
$string['forumtrackaria'] = 'Click to track this forum.';
$string['forumtrackednot'] = 'Unread posts are not being tracked';
$string['forumuntrackaria'] = 'Click to stop tracking this forum.';
...
$string['forwardintro_help'] = 'Optional introduction: ';
$string['forwardpreface'] = '<p>This forum post was sent to you on behalf of <a href="{$a->link_to_sender}">{$a->name}</a> via the forum {$a->forum_name} in course <a href="{$a->course_link}">{$a->course_full}</a> {$a->course_unique}.</p>';
$string['forwardtitle'] = 'Send post';
$string['forumislocked'] = 'Forum is locked';
$string['forummanagers'] = 'For users with manage capabilities';
$string['from'] = 'from';
...
$string['hideauthor_help'] = 'You can choose to hide the authors names and instead display their roles. <strong>This option can be changed anytime. This does not make the forum anonymous!</strong>';
$string['hideauthorcomment'] = '<b>The forum is not anonymous, hiding can be cancelled!</b>';
$string['imageshandlednotification'] = 'Some images were rmoved from this message, to see these images, please view this messege on your browser';
$string['incorrectpostid'] = 'Post id is incorrect';
$string['inforum'] = 'in {$a}';
...
$string['linktopost'] = 'Link to post';
$string['linktopostfield'] = 'The post link field';
$string['linktoposttitle'] = 'Copy link to post';
$string['lockdiscussion'] = 'lock discussion';
$string['locked'] = 'Locked for writing';
$string['lockedlabel'] = 'Lock';
$string['lockedlabel_help'] = 'The forum has two options:

* Open for writing (default).
...
$string['mailnow_help'] = 'Usually posts are sent to subscribed users 15 minutes after being posted.<br>
Check this option to send your post right now.';
$string['mailmessage'] = 'Mail post';
$string['manydiscussions'] = 'Discussions per page';
$string['markalldread'] = 'Mark all posts in this discussion read.';
$string['markallread'] = 'Mark all posts in this forum read.';
$string['markallreadtext'] = 'Mark as read';
$string['marknew'] = 'Mark';
...
$string['messagesmarked'] = 'There are marked messages';
$string['misconfiguredforum'] = 'Forum is misconfigured - could not find its course';
$string['missingforumid'] = 'You need to define a forum id';
$string['messageprovider:digests'] = 'Subscribed forum digests';
$string['messageprovider:posts'] = 'Subscribed forum posts';
$string['missingpostid'] = 'Post id is missing';
...
$string['move:notsamecourse'] = 'The destination forum must be in the same course';
$string['move:originaldiscussion'] = 'The original discussion';
...
$string['modediscussions'] = 'Display discussions';
...
$string['navigate:closediscussions'] = 'Navigate between close discussions';
...
$string['nopostscontaining'] = 'Could not find posts containing \'{$a}\'';
...
$string['opendiscussionthread'] = 'Expand discussion';
...
$string['pagingbar:first'] = 'First page';
$string['pagingbar:last'] = 'Last page';
$string['pagingbar:next'] = 'Next page';
$string['pagingbar:previous'] = 'Previous page';
$string['parent'] = 'Show parent';
$string['parentofthispost'] = 'Parent of this post';
$string['partialtext'] = 'Partial text';
$string['personalflag'] = 'A post flagged by me';
$string['pgl:loadbutton'] = 'Gallery display of all pictures in the post';
$string['pgl:buttonclose'] = 'Close gallery display';
$string['pgl:buttonnext'] = 'Next picture';
$string['pgl:buttonprev'] = 'Previous picture';
$string['pindiscussion'] = 'Pin discussion';
$string['pinneddiscussion'] = 'Pinned discussion';
$string['pinnedmessage_icons'] = 'Pinned post';
$string['placeholderreplysubject'] = 'Reply subject...';
$string['placeholderreplycontent'] = 'Reply content...';
$string['placeholderdiscussionsubject'] = 'Discussion subject...';
$string['placeholderdiscussioncontent'] = 'Discussion content...';
$string['postattachments'] = 'The post contains attachments';
$string['postempty'] = 'The post has no content';
$string['postflag'] = 'This post is flagged';
$string['postnoreplies'] = 'The post has no replies';
$string['postrecommend'] = 'This post is recommended';
$string['postreplies'] = 'The post has {$a} replies';
$string['postreply'] = 'The post has one reply';
$string['posttodelete'] = 'The post to be deleted';
...
$string['posttosend'] = 'The post to send';
...
$string['postbymailsuccess'] = 'Your forum post with subject "{$a->subject}" was successfully added. You can view it at {$a->discussionurl}.';
...
$string['posthasattachments'] = 'The post contains attachments';
$string['postincontext'] = 'See this post in context';
$string['postingfailed'] = 'Posting failed due to communication error';
...
$string['publishdate'] = 'Published in';
$string['publishedby:editingteacher'] = 'Published by coordinator';
$string['publishedby:namedate'] = 'by {$a->name} on {$a->date}';
$string['publishedby:teacher'] = 'Published by instructor';
...
$string['re'] = 'Re:';
$string['reachedreplieslimit'] = 'This discussion has a very large amount of relpies. To view the full discussion click here.';
$string['readtherest'] = 'Read the rest of this topic';
$string['recommend'] = 'Recommend';
$string['recommend_alt'] = 'Recommend alt';
$string['recommendpost'] = 'Recommend';
$string['remove'] = 'Remove';
$string['removed_attachments'] = '* Attachments are not sent in email';
$string['replies'] = 'Replies';
$string['repliesamount'] = 'Replies amount';
$string['replieslimit'] = 'Replies per discussion';
$string['repliesmany'] = '{$a} replies so far';
$string['repliesone'] = '{$a} reply so far';
$string['reply'] = 'Reply';
$string['replyforum'] = 'Reply to forum';
$string['replyprefix'] = 'Reply for:';
...
$string['searchplaceholder'] = 'Search content';
...
$string['send'] = 'Send';
$string['sendbymail'] = 'Send by e-mail';
$string['shortnamedelimiter'] = 'Delimiter for extracting short name';
$string['shortpost'] = 'Short post';
$string['showsubscribers'] = 'Show/edit current subscribers';
$string['singleforum'] = 'A single simple discussion';
$string['smallmessage'] = '{$a->user} posted in {$a->forumname}';
$string['splitshortname'] = 'Extract from course short name';
$string['splitshortname:none'] = 'Do not extract';
$string['splitshortname:pre'] = 'Extract from the start';
$string['splitshortname:post'] = 'Extract from the end';
$string['startedby'] = 'Started by';
$string['strconsubject'] = 'The course Forum';
$string['strmsgtitle'] = 'Text of the message on the forum';
$string['strpostby'] = 'Posted by';
$string['strsubject'] = 'The post was send regarding a forum post with subject';
$string['strsubjectprint'] = 'Post from forum titled';
$string['subject'] = 'Subject';
$string['subscribe'] = 'Subscribe to this forum';
$string['subscribediscussion'] = 'Subscribe to this discussion';
$string['subscribediscussion:no'] = 'Unsubscribe from discussion';
$string['subscribediscussion:nolabel'] = 'Stop receiveing email notifications on updates in this discussion';
$string['subscribediscussion:yes'] = 'Subscribe to discussion';
$string['subscribediscussion:yeslabel'] = 'Receive email notifications in discussion';
...
$string['subscribeforum:no'] = 'Unsubscribe from forum';
$string['subscribeforum:nolabel'] = 'Stop receiveing email notifications on updates in the forum';
$string['subscribeforum:yes'] = 'Subscribe to forum';
$string['subscribeforum:yeslabel'] = 'Receive email notifications on updates in the forum';
$string['subscribeforumindex:no'] = 'Unsubscribe from forums';
$string['subscribeforumindex:nolabel'] = 'Stop receiveing email notifications on updates in all forums';
$string['subscribeforumindex:yes'] = 'Subscribe to forums';
$string['subscribeforumindex:yeslabel'] = 'Receive email notifications on updates in all forums';
$string['subscribeforums'] = 'Start and stop subscriptions to all forums';
$string['subscribeno'] = 'Unsubscribe';
...
You can also choose to subscribe to the forum instead of just this discussion.';
$string['subscriptiondiscussiondisallowed'] = 'You cannot subscribe to discussions in this forum';
$string['subscriptiondiscussiondisallowed_help'] = 'In a forum where subscription is disabled, discussion subscription is not available';
$string['subscriptiondiscussionforum'] = 'You are subscribe to the forum';
$string['subscriptiondiscussionforum_help'] = 'Subscription to a single discussion is not available when you are subscribed to the forum';
$string['subscriptiondiscussionno'] = 'Unsubscribe';
$string['subscriptiondiscussionyes'] = 'Subscribe';
...
$string['tocoursesite'] = 'To course site';
$string['todate'] = 'To date';
$string['trackforum'] = 'Track unread posts';
$string['tracking'] = 'Track';
$string['tracking:no'] = 'Untrack forum';
$string['tracking:nolabel'] = 'Do not mark unread posts';
$string['tracking:yes'] = 'Track forum';
$string['tracking:yeslabel'] = 'Mark unread posts';
$string['trackingindex:no'] = 'Untrack forums';
$string['trackingindex:nolabel'] = 'Do not mark unread posts in all forums';
$string['trackingindex:yes'] = 'Track forums';
$string['trackingindex:yeslabel'] = 'Mark unread posts in all forums';
...
$string['trackno'] = 'Untrack';
$string['trackyes'] = 'Track';
$string['tutor'] = 'Tutor';
$string['undorecommend'] = 'Unrecommend';
$string['unflagpost'] = 'Unflag post';
$string['unlockdiscussion'] = 'Unlock discussion';
$string['unlocked'] = 'Unlocked for writing';
$string['unlockedtiming'] = 'Unlock this forum for writing in this date range:';
$string['unlockmessage'] = 'Unpin message';
$string['unpindiscussion'] = 'Unpin discussion';
$string['unread'] = 'Unread';
$string['unreadposts'] = 'Unread posts';
$string['unreadpostsnumber'] = '{$a} unread posts';
$string['unreadpostsone'] = '1 unread post';
$string['unrecommendpost'] = 'Undorecommend';
